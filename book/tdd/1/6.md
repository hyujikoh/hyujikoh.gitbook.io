...
앞서 5장에서 수행한 `Franc` 테스트를 통과하기 위해 이전에 사용한 `Dollar` 코드를 끌어다가 사용하였다. 이 중복된 코드를 제거하기 위한 방법중 하나가, 다른 클래스를 상속받게 하는 것이다(interface or abstract class 와같은)<br>

<div align="left"><figure><img src="../../../.gitbook/assets/image (57).png" alt=""><figcaption><p>Money 라는 공통 상위 클래스</p></figcaption></figure></div>
