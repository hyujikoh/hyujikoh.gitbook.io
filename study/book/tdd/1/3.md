...
값 객체는 equals() 구현해야하고,  Dollar를 해시 테이블의 키로 쓸 생각이라면 추가로 hashCode()를 같이 구현해야 한다. ([java Object 에 기본 메소드인 equals 와 hashCode 에 대해 참고 포스트](../../../back-end/java/undefined/equals-hashcode.md))
