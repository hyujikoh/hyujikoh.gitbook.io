...
구조의 공통점은, “모든 관심사를 한 곳에서 직접 관리하려고 한다”는 것에 있었습니다.

기능들을 구현하면서 의식적으로 이런 질문들이 나왔습니다.
...
이번에 작성하는 글은 Spring Event 에 대해 딥다이브 한 내용을 소개하는게 아니라 \
고민의 과정을 정리한 글입니다. 이벤트를 거창한 기술이나 패턴이 아니라,
...
그래서 첫 번째로 손댄 부분은,\
**“비즈니스의 중심이 되는 사건”을 도메인 스스로 말하게 하는 것**이었습니다.\
...
* “도메인 입장에서 중요한 사건”은 **도메인 이벤트**
* “도메인 밖(분석/플랫폼)에서 중요하게 보는 사건”은 **응용/인프라 전용 이벤트**
